    ...
    return (
      <>
        ...
        <div style={{ placeItems: "center" }}>
          ...
          <p>
            Sono organi del comitato: - l'Assemblea; \n - il Consiglio
            direttivo; \n - il Presidente; \n - il Tesoriere; \n Tutti gli
            organi restano in carica fino allo scioglimento, salva la facoltà di
            sostituire i soggetti titolari delle cariche secondo le previsioni
            del presente statuto. Il Presidente, il Tesoriere e tutti i
            componenti di organi collegiali del comitato cessano dalla carica
            per dimissioni, impedimento permanente o morte. I membri del
            Consiglio direttivo cessano dalla carica altresì ove ne sia
            deliberata la sostituzione da parte dell'Assemblea.
          </p>
