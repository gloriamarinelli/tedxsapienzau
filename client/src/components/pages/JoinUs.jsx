      ...
      <>
        ...
        <section style={{ fontSize: "20px", marginTop: "30px" }}>
          <div className="container-lg marketing">
            ...
            >
              Entra a far parte di questo progetto meraviglioso, pieno di
              stimoli e opportunità di crescita. Non vediamo l'ora di leggere la
              tua storia!
            </p>
          </div>
          ...
          <div className="container-lg marketing">
            ...
            >
              ...
              <strong>regolarmente iscritti </strong> ad un corso di laurea,
              laurea magistrale, master, dottorato o scuola di specializzazione{" "}
              <strong>
                <u>presso l'ateneo Sapienza Università di Roma</u>
              </strong>{" "}
              e si chiuderanno il giorno{" "}
              <strong> 26/02/2024 alle ore 23:59 </strong>.
            </p>
          </div>
          ...
          <div className="container-lg marketing">
            ...
            >
              ...
              <strong>info@tedxsapienzau.com</strong>
            </p>
