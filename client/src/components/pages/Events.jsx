...
export default function Editions({ withTitle = true }) {
  ...
  const eventsInfo = [
    {
      date: i18n.language === "it" ? "11 Aprile 2025" : "April 11, 2025",
      title: "PARA DOXA",
      description:
        i18n.language === "it"
          ? "PARA DOXA è lo spazio dove i paradossi, da antichi esercizi di logica alle contraddizioni del mondo moderno, si trasformano in strumenti di riflessione e confronto per generare idee capaci di cambiare la realtà."
          : "PARA DOXA is the space where paradoxes, from ancient exercises in logic to the contradictions of the modern world, are transformed into tools for reflection and confrontation to generate ideas capable of changing reality.",
      photo: CoverParaDoxa25,
      linkTo: "/eventi/paradoxa2025",
    },
    {
