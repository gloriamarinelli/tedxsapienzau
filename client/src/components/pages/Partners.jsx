...
import PartnersMobileLayout from "../components/PartnersMobileLayout"; // Partners 2024
import PartnersDesktopLayout from "../components/PartnersDesktopLayout"; // Partners 2024
...
Red Bull Basement, il Global Student Project che mette alla prova gli studenti universitari di tutto il mondo spingendoli a trovare idee che possano migliorare il mondo."
  ...
  function getPartners2024() {
    let currentLayout;
    if (windowSize > global.UTILS.TABLET_WIDTH) {
      currentLayout = <PartnersDesktopLayout />;
    } else {
      currentLayout = <PartnersMobileLayout />;
    }
  ...
  function selectYear() {
    if (activeYear === 22) return getPartners2022();
    else if (activeYear === 23) return getPartners2023();
    else return getPartners2024();
  }
